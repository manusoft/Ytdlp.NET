...
internal static class TestConstants
{
    ...
    public static readonly string FakeExePath = OperatingSystem.IsWindows() ? "yt-dlp.exe" : "yt-dlp";
    public static readonly string FakeFfmpegPath = OperatingSystem.IsWindows() ? "ffmpeg.exe" : "ffmpeg";
