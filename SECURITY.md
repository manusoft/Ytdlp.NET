...
Instead, report it privately using this repository's [GitHub private vulnerability reporting tool](https://github.com/manusoft/Ytdlp.NET/security/advisories/new).
...
We aim to respond within 2 business days, and will work with you to assess and resolve the issue promptly. If a fix requires more time, well provide regular status updates until its resolved.
